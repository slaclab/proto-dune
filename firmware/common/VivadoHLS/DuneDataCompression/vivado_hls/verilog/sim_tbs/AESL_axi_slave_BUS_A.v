...
parameter monitor_common_pattern_data_in_addr = 256;
parameter monitor_cfg_m_mode_data_in_addr = 264;
parameter monitor_cfg_m_ncfgs_data_in_addr = 272;
...
parameter monitor_write_nbytes_data_in_addr = 512;
parameter monitor_write_npromoted_data_in_addr = 520;
parameter monitor_write_ndropped_data_in_addr = 528;
parameter monitor_write_npackets_data_in_addr = 536;
...
reg  BREADY_reg = 0;
reg [DATA_WIDTH - 1 : 0] mem_BUS_A [BUS_A_DEPTH - 1 : 0];
