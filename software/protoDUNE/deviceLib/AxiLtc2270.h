...
//! Class to contain AxiLtc2270
class AxiLtc2270 : public Device {
   ...
   public:
      ...
      */
      AxiLtc2270 ( uint32_t linkConfig, uint32_t baseAddress, uint32_t index, Device *parent, uint32_t addrSize=1 );
