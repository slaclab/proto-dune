...
// 27/04/2015: created
//-----------------------------------------------------------------------------
#ifndef __JESD_TX_COMMON_H__
#define __JESD_TX_COMMON_H__

#include <Device.h>
#include <stdint.h>
using namespace std;

//! Class to contain JesdTx
class JesdTx : public Device {
   ...
   public:
      ...
      */
      JesdTx ( uint32_t linkConfig, uint32_t baseAddress, uint32_t index, Device *parent, uint32_t addrSize=1 );
