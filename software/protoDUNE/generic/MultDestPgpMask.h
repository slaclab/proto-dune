...
// 06/18/2014: created
//-----------------------------------------------------------------------------
#ifndef __MULT_DEST_PGP_MASK_H__
#define __MULT_DEST_PGP_MASK_H__
#include <MultDest.h>
#include <string>
#include <stdint.h>
using namespace std;
...
class MultDestPgpMask : public MultDest {
   ...
   public:
      ...
      //! Constructor
      MultDestPgpMask (string path, uint mask);
