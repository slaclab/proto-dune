...
// 11/05/2015: created
//-----------------------------------------------------------------------------
#ifndef __DATA_DPM_WIB_H__
#define __DATA_DPM_WIB_H__

#include <Device.h>
#include <stdint.h>
using namespace std;

class DataDpmWib:public Device {        
 public:
    DataDpmWib ( uint32_t linkConfig, uint32_t baseAddress, uint32_t index, Device *parent, uint32_t addrSize=1 );
    ~DataDpmWib( ); 
